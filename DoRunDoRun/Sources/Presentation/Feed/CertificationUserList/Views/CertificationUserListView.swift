//
//  CertificationUserListView.swift
//  DoRunDoRun
//
...
struct CertificationUserListView: View {
    @Perception.Bindable var store: StoreOf<CertificationUserListFeature>
...
// MARK: - Main Section
private extension CertificationUserListView {
    /// Main Secition
    @ViewBuilder
        ...
        ScrollView {
            LazyVStack(spacing: 0) {
                ForEach(store.users) { user in
                    CertificationUserListRowView(user: user) {
