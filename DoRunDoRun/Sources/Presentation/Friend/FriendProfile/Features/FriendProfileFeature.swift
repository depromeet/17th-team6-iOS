...
struct FriendProfileFeature{
    ...
    struct State: Equatable {
        // MARK: Navigation
        @Presents var feedDetail: FeedDetailFeature.State?
    ...
    enum Action: Equatable {
        ...
        case feedDetail(PresentationAction<FeedDetailFeature.Action>)
    ...
    var body: some ReducerOf<Self> {
        ...
        Reduce { state, action in
            ...
            case let .feedItemTapped(feed):
                state.feedDetail = FeedDetailFeature.State(feedId: feed.feedID, feed: feed)
                return .none
